...
function AboutMe(){
    return(
        <>
        <section className='flex flex-col items-center justify-center w-full h-screen bg-[var(--color05)] text-[var(--color04)]'>
                <h1 className='font-semibold text-4xl font-[var(--fontTitle)]'>Sobre Mim</h1>
