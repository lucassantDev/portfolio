    ...
    return (
        <>
            <section className="w-full h-screen flex flex-col items-center lg:items-start justify-center gap-12">
                ...
                <Link to="/tecnologias"><h1 className="text-4xl text-blue-400 text-center font-bold lg:text-blue-800 lg:ml-12  lg:text-9xl lg:cursor-pointer lg:transition duration-200 hover:text-blue-400">tecnologias & ferramentas</h1></Link>
                <Link to="/certificados"><h1 className="text-4xl font-bold text-blue-400 text-center lg:text-blue-800 lg:ml-12 lg:text-9xl lg:cursor-pointer lg:transition duration-200 hover:text-blue-400">formações & certificados</h1></Link>
