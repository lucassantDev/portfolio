...
function AboutMe() {
    return (
        <>
            <section className="w-full h-fit border">
                ...
                <div className="w-full h-fit py-6  border flex flex-col items-center">
                    <img src="./src/assets/img/lucas.jpeg" className="w-5/6 shadow-md lg:shadow-xl object-cover lg:h-144" alt="Imagem de Lucas Santana" />
                    <h1 className="mt-6 border w-5/6 font-bold text-2xl lg:text-left lg:text-6xl">Sobre Mim</h1>
                    <p className="border w-5/6 lg:text-4xl font-semibold text-gray-500">
